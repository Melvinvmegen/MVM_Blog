...
## Why Unintuitive?
Merge sort involves a recursive function, which can be unintuitive for some. If you're not familiar with recursion, you might want to refer to my guide on recursion [here](/posts/javascript/recursion).
