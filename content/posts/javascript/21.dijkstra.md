---
id: 21
title: "Dijkstra's Algorithm: The Shortest Path Finder"
...
To understand this algorithm we first need to understand weighted graphs, I won't go into much details about graphs themselves since I did a blog post which you can find in my [blog post on graphs](/posts/javascript/graph). What I will do is highlight the major difference between them.
...
2. Use a [priority queue](/posts/javascript/queue) to process nodes by current shortest distance
