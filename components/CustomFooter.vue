      ...
      <div class="grid-1 grid gap-8 md:grid-cols-3 lg:grid-cols-3">
        <div class="">
          ...
          <div class="flex justify-center md:justify-start">
            <NuxtLink to="#" class="mr-6 text-white dark:text-neutral-200">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-4 w-4"
                fill="currentColor"
            ...
            <NuxtLink to="https://linkedin.com/in/melvin-van-megen" class="mr-6 text-white dark:text-neutral-200">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-4 w-4"
                fill="currentColor"
            ...
            <NuxtLink to="https://github.com/Melvinvmegen" class="text-white dark:text-neutral-200">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-4 w-4"
                fill="currentColor"
        ...
        <div class="flex flex-col items-center">
          ...
          <p
            ...
            :to="item.link"
          >
            <NuxtLink :to="item.link" class="text-white hover:text-secondary" active-class="text-secondary">{{ item.name }}</NuxtLink>
          </p>
        </div>
        <div class="flex flex-col items-center">
          <h6
